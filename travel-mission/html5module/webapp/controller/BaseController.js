sap.ui.define(
  ...
  function (
    ...
    return Controller.extend("ui5app.controller.BaseController", {
       ...
       * @private
       * @returns {ui5app.ui.BusyDialog} the router for this component
       */
      getBusyFragment: async function () {
        if (!this.oBusyDialog) {
          this.oBusyDialog = await Fragment.load({
            id: this.getView().getId(),
            name: "ui5app.view.fragments.GenericBusyDialog",
            controller: this,
          });
      ...
      onOverflowMenuOpen: function () {
        ...
        if (!this._oMenuFragment) {
          this._oMenuFragment = Fragment.load({
            id: oView.getId(),
            name: "ui5app.view.fragments.HeaderOverflowMenuPopover",
            controller: this,
          }).then(function (oMenu) {
      ...
      onOpenErrorPane: async function () {
        ...
        if (!this._oErrorPane) {
          this._oErrorPane = await Fragment.load({
            id: oView.getId(),
            name: "ui5app.view.fragments.ErrorPane",
            controller: this,
          });
