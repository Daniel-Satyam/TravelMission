...
sap.ui.define(
  ...
  function (
    ...
    return BaseController.extend("ui5app.controller.CreateMission", {
      onInit: function (evt) {
      ...
      saveMission: async function () {
        ...
        // console.log("Deletegate approver => " + delegateApprover);

        var missionBudgetAvailable =
          parseFloat(missionInfoModelData.budgetAvailable) -
          parseFloat(missionInfoModelData.totalExpense);
        var missionParkedAmount =
          parseFloat(missionInfoModelData.budgetParked) +
          parseFloat(missionInfoModelData.totalExpense);
      ...
      openSearchEmployeeDialog: async function (guid) {
        ...
        if (!this._oSearchEmployeeDialog) {
          this._oSearchEmployeeDialog = await Fragment.load({
            ...
            name: "ui5app.view.fragments.SearchEmployee",
            controller: this,
          });
      ...
      //   } else {
      //     this.alertMessage("E", "errorOperation", "memberLackOfPayGrade", [],null);
      //     // MessageBox.error("The selected member not having payGrade", {
      //     //   actions: [MessageBox.Action.CLOSE],
      //     //   onClose: function (sAction) {},
      //     //   dependentOn: that.getView(),
