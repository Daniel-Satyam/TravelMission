sap.ui.define(
  ...
  function (
    ...
    return BaseController.extend("ui5appuat.controller.ApproveAdvance", {
        ...
        var obj = {
          ...
          byDelegate:
            ...
            decryptedDataParsed.keyVault.user.id
              ? `${decryptedDataParsed.keyVault.user.firstName} ${decryptedDataParsed.keyVault.user.lastName} (${decryptedDataParsed.keyVault.user.id})`
              : null,
          payload: payload,
        };
