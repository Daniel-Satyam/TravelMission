...
sap.ui.define(
    ...
    function (
       ...
       * <ul>
       * <li>The screen is not supposed to be blocked. Use a {@link ui5appuat.ui.BusyIndicator} for the specific application part.</li>
       ...
       *
       * @public
       * @alias ui5appuat.ui.BusyDialog
       */
      var BusyDialog = Control.extend(
        "ui5appuat.ui.BusyDialog",
        /** @lends ui5appuat.ui.BusyDialog.prototype */ {
          metadata: {
            library: "ui5appuat.ui",
            properties: {
              /**
