sap.ui.define(["sap/ui/core/Control"], function (Control) {
   ...
   */
  return Control.extend("ui5appstage.ui.MultiSelectComboBox", {
    metadata: {
      properties: {
        /**
    ...
    init: function () {
      ...
      const sLibraryPath = jQuery.sap.getModulePath("ui5appstage"); //get the server location of the ui library
