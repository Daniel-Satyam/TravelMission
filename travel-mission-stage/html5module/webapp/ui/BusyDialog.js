...
sap.ui.define(
    ...
    function (
       ...
       * <ul>
       * <li>The screen is not supposed to be blocked. Use a {@link ui5appstage.ui.BusyIndicator} for the specific application part.</li>
       ...
       *
       * @public
       * @alias ui5appstage.ui.BusyDialog
       */
      var BusyDialog = Control.extend(
        "ui5appstage.ui.BusyDialog",
        /** @lends ui5appstage.ui.BusyDialog.prototype */ {
          metadata: {
            library: "ui5appstage.ui",
            properties: {
              /**
      ...
      BusyDialog.prototype.isOpen = function () {
        ...
        if (!this._oLabel) {
          if (sText) {
            this._oLabel = new Label(this.getId() + "-TextLabel", {
              text: sText,
            }).addStyleClass("sapMBusyDialogLabel").addStyleClass("customBusyDialogLabel");
