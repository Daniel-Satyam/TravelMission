sap.ui.define(
  ...
  function (
    ...
    return BaseController.extend("ui5appstage.controller.ApproveCancel", {
      ...
      approveCancel: async function (oEvent) {
        const that = this;
        ...
        jQuery.ajax({
          ...
          success: async function (data, textStatus, jqXHR) {
            ...
            // MessageBox.success("The mission cancellation is approved by " + decryptedDataParsed.keyVault.user.firstName + " " + decryptedDataParsed.keyVault.user.lastName, {
      ...
      rejectCancel: async function (oEvent) {
        const that = this;
        ...
        jQuery.ajax({
          ...
          success: async function (data, textStatus, jqXHR) {
            ...
            // MessageBox.success("The mission cancellation is sent back by " + decryptedDataParsed.keyVault.user.firstName + " " + decryptedDataParsed.keyVault.user.lastName, {
            // 	actions: [MessageBox.Action.CLOSE],
            // 	onClose: async function (sAction) {
            // 		await that.initializeModel();
            // 		await that.initiateDynamicMembers();
