        ...
        formatDateHistory: function(dt) {
            if(dt != null) {
                ...
                const monthNames = ["Jan", "Feb", "Mar", "Apr",
                    "May", "Jun", "Jul", "Aug",
                    "Sep", "Oct", "Nov", "Dec"];
                return monthNames[(formattedDate.getMonth())] + " " + formattedDate.getDate() + ", " + formattedDate.getFullYear() + " - " + formattedDate.getHours() + ":" + formattedDate.getMinutes() + ":" + formattedDate.getSeconds() ;
            }
        },
